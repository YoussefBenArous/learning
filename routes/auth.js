...
const {createUser} = require('../controlleur/usercontrolleur');
const {updateUser} = require('../controlleur/usercontrolleur');
const {deletuser} = require('../controlleur/usercontrolleur');
